...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <a class="navbar-brand" href="#" style="font-size:30px;"><strong>Final Project</strong></a>
...
<div class="container my-4">
    <div class="card mx-auto" style="width: 20rem;">
        <br>
        <img class="card-img-top mx-auto" src="images/isufst.png" style="width: 60%;" alt="Card image cap">
        <div class="card-body">
